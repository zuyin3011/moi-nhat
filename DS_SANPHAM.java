   ...
   public void Sua() {
    ...
    if (maSP.startsWith("dc")) {
        ...
        for (int i = 0; i < dssp.length; i++) {
            if (dssp[i] != null && dssp[i].getMaSP().equals(maSP)) {
                index = i;
                break;
            }
        }
        if (index != -1) {
            ...
            System.out.println("Khong tim thay SP co ma " + maSP);
        }
    }
...
public void Xoa() {
 ...
 public void timKiem(){
   ...
   boolean check=false;
    for (int i=0; i<dssp.length; i++){
        if (dssp[i] != null && dssp[i].getMaSP().equals(ID)){
            check=true;
            break;
        }
    }
    if (check==true){
        ...
        break;}
                ...
                case 2:
					...
					boolean check = false;
					for (int i = 0; i < dssp.length;i++) {
                                                                                                         if (dssp[i].getTenSP().toUpperCase().compareTo(tenSP) == 0) {
							check = true;
							break;
						}
					}
					if (check == true) {
						for (int i = 0; i < dssp.length; i++) {
							if (dssp[i].getTenSP().toUpperCase().equals(tenSP) == true) {
                                                                                                                                                        dssp[i].output();
                                                                                                                                                         System.out.println("--------------------");
            ...
            break;
                case 3:
					...
					boolean check = false;
					for (int i = 0; i <dssp.length;i++) {
						if (dssp[i].getGiaBan()>giaThapNhat && dssp[i].getGiaBan()<giaCaoNhat ){
							check = true;
							break;
						}
					}
        ...
        switch (choice) {
            case 1:{
                    boolean check = false;
                      for (int i=0; i< dssp.length; i++){
                            if (dssp[i].getLoai().equals("Dung Cu Hoc Tap")){
                                check=true;
                                break;
                            }
                        }
